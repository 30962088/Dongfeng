...
//		    Log.d("pulldownview", "RTPullListView setSelection(0) 1");
			setSelection(0);
		}
	}
		...
		if (isRefreshable) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (state != REFRESHING && isRecored && state != LOADING) {
					...
					// 可以松手去刷新了
					if (state == RELEASE_To_REFRESH) {
//					    Log.d("pulldownview", "RTPullListView setSelection(0) 2");
						setSelection(0);
					...
					if (state == PULL_To_REFRESH) {
//					    Log.d("pulldownview", "RTPullListView setSelection(0) 3");
//						setSelection(0);
	...
	public void onRefreshComplete() {
		state = DONE;
		lastUpdatedTextView.setText("加载中..." + new Date().toLocaleString());
		changeHeaderViewByState();
		invalidateViews();
//		Log.d("pulldownview", "RTPullListView setSelection(0) 4");
		setSelection(0);
	}
